...
fn test_lda() {
    ...
    assert_eq!(inst.opcode, Opcode::LDA);
...
fn test_ldx() {
    ...
    assert!(!cpu.status.contains(Flags::NEGATIVE));
    assert!(!cpu.status.contains(Flags::ZERO));
    assert_eq!(inst.opcode, Opcode::LDX);
    assert_eq!(inst.cycles, 2);
...
fn test_ldy() {
    ...
    assert!(!cpu.status.contains(Flags::NEGATIVE));
    assert!(!cpu.status.contains(Flags::ZERO));
    assert_eq!(inst.opcode, Opcode::LDY);
    assert_eq!(inst.cycles, 2);
...
fn test_sta() {
    ...
    assert_eq!(inst.opcode, Opcode::STA);
    assert_eq!(inst.cycles, 3);
...
fn test_stx() {
    ...
    assert_eq!(cpu.pc, 0x2002);
    assert_eq!(bus.mem_read(0x42), 0x42);
    assert_eq!(inst.opcode, Opcode::STX);
    assert_eq!(inst.cycles, 3);
...
fn test_sty() {
    ...
    assert_eq!(cpu.pc, 0x2002);
    assert_eq!(bus.mem_read(0x42), 0x42);
    assert_eq!(inst.opcode, Opcode::STY);
    assert_eq!(inst.cycles, 3);
...
fn test_tax() {
    ...
    assert!(!cpu.status.contains(Flags::NEGATIVE));
    assert!(!cpu.status.contains(Flags::ZERO));
    assert!(matches!(inst.opcode, Opcode::TAX));
    assert_eq!(inst.cycles, 2);
...
fn test_tay() {
    ...
    assert!(!cpu.status.contains(Flags::NEGATIVE));
    assert!(!cpu.status.contains(Flags::ZERO));
    assert!(matches!(inst.opcode, Opcode::TAY));
    assert_eq!(inst.cycles, 2);
...
fn test_txa() {
    ...
    assert!(!cpu.status.contains(Flags::NEGATIVE));
    assert!(!cpu.status.contains(Flags::ZERO));
    assert!(matches!(inst.opcode, Opcode::TXA));
    assert_eq!(inst.cycles, 2);
...
fn test_tya() {
    ...
    assert!(!cpu.status.contains(Flags::NEGATIVE));
    assert!(!cpu.status.contains(Flags::ZERO));
    assert!(matches!(inst.opcode, Opcode::TYA));
    assert_eq!(inst.cycles, 2);
